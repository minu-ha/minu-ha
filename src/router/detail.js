...
let YellowBtn = styled.button`
  ...
  color: ${(props) => (props.bg == 'blue' ? 'white' : 'black')} padding 10px;
`;
      ...
      <div className="row">
        ...
        <div className="col-md-6">
          ...
          <button
            ...
            onClick={() => {
              dispatch(addItem({ id: 1, name: 'yo', count: 3 }));
            }}
          >
            주문하기
          </button>
...
function TabBody({ tab, shoes }) {
  ...
  return (
    <div className={'start ' + fade}>{[<div></div>, <div>bbb</div>, <div>내용</div>][tab]}</div>
  );
}
